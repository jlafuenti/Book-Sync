...
_PERSONAL_DATA_RULES = {
    ...
    "deploy_path": re.compile(r"/usr/share/docker-containers"),
...
_PERSONAL_DATA_ALLOWLIST = {
    ...
    # -- Pending the docs/CLAUDE.md scrub (issue #188). These are real leaks,
    # not examples; they are allow-listed only so this guard can land ahead of
    # the file changes that remove them. Delete these entries when #188 lands --
    # a stale entry is inert, but it is also a lie.
    ("CLAUDE.md", "deploy_path"): "pending the #188 scrub",
    ("CLAUDE.md", "ssh_alias"): "pending the #188 scrub",
    ("docs/handoff-position-sync.md", "deploy_path"): "pending the #188 scrub",
    ("docs/handoff-position-sync.md", "ssh_alias"): "pending the #188 scrub",
    ("docs/handoff-position-sync.md", "device_serial"): "pending the #188 scrub",
}
